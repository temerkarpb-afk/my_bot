        ...
        const response = await fetch("https://api.groq.com/openai/v1/chat/completions", {
            ...
            body: JSON.stringify({
                ...
                messages: [
                    { 
                        role: "system", 
                        content: "Ты — продвинутый CyberBot v2.0. Ты знаешь всё о медийных личностях (Арсен Маркарян, Вито Бассо и др.). Отвечай грамотно, ставь запятые, не используй символы * # _. Только чистый текст." 
                    },
                    ...messages
                ],
                temperature: 0.5
